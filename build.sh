...
#export
export CROSS_COMPILE="$HOME/android/kernels/toolchain/arm64-gcc/bin/aarch64-elf-"
export CROSS_COMPILE_ARM32="$HOME/android/kernels/toolchain/arm32-gcc/bin/arm-eabi-"
export ARCH=arm64
